...
class Interceptor extends \Magento\Swatches\Block\LayeredNavigation\RenderLayered implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwatchPath');
        if (!$pluginInfo) {
            return parent::getSwatchPath($type, $filename);
        } else {
            return $this->___callPlugins('getSwatchPath', func_get_args(), $pluginInfo);
        }
    }
